def cone():
    ...
    while ask_r != 'int' and ask_r != 'float':
        # if the input type of radius is not float or integer, but radius input is empty, this will run, else the input type of height is not float or integer, but something different, this will run!
        if ask_r == '':
    ...
    while ask_h != 'int' and ask_h != 'float':
        # if the input type of height is not float or integer, but height input is empty, this will run, else the input type of height is not float or integer, but something different, this will run!
        if ask_h == '':
    ...
    # if the input type of radius is integer, but radius input is empty, this will run, else the input type of radius is float, but radius input is empty, this will run!
    if ask_r == 'int':
        while rad == '':
    ...
    # if the input type of height is integer, but height input is empty, this will run, else the input type of height is float, but height input is empty, this will run!
    if ask_h == 'int':
        while h == '':
    ...
    # if the input of the radius and input of height is all float, it will run this, else the input of the radius and input of height is integer and float respectively, it will run this!
    if ask_r == 'float':
        if ask_h == 'float':
            r = float(rad) ** 2
            b = 1 * pi * r * float(h)
        ...
        if ask_h == 'int':
            ...
            b = 1 * pi * r * float(h)
            z = b/3
            print('The volume of the cone result is >>>',z)
